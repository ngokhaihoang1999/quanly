...
'',
'=== BẢN ĐỒ KỸ THUẬT & TOÀN BỘ CƠ CHẾ CODE CỦA MINI APP ===',
'1. VỊ TRÍ & THUẬT TOÁN BẢNG DÒNG THỜI GIAN (TIMELINE 3 CỘT):',
'   - Vị trí: Nằm trong MÀN HÌNH CHI TIẾT HỒ SƠ ➡️ TAB 2: GIAI ĐOẠN (không phải Tab Lịch hay Tab Ghi chú!).',
'   - Cấu trúc: Cột 1: 🗓️ Sự kiện (lịch hẹn hen_tv) | Cột 2: 📝 Báo cáo (bc_tv, bc_bb) | Cột 3: 📚 BTVN (bài tập nộp).',
'   - Thuật toán ghép hàng: Hàm loadProfileRecords() nhóm hen_tv và bc_tv có cùng chỉ số session_number nằm trên CÙNG 1 HÀNG NGANG.',
'',
'2. CƠ CHẾ BIẾN CHUYỂN DỮ LIỆU & TRẠNG THÁI (STATE MUTATIONS):',
'   - Mở Kinh Thánh (is_kt_opened): Hàm toggleKTStatus() đổi is_kt_opened=true ➡️ tạo bản ghi mo_kt trong DB ➡️ chuyển phase từ tu_van sang bb ➡️ làm mới Timeline.',
'   - Duyệt Hapja (approveHapjaRecord): GGN bấm Duyệt ✅ ➡️ chuyển phiếu Chờ duyệt sang Đã duyệt ➡️ tạo bản ghi profiles với fruit_status=alive.',
'   - 3 Trạng thái hồ sơ: 🟢 Alive (hoạt động) | ⏸️ Pause (tạm nghỉ ngắn hạn: ốm, bận, đổi ca, bảo lưu 1-2 tuần) | 🔴 Drop-out (nghỉ hẳn, lưu lý do dropout_reason).',
  '   - 4 Mốc tiến độ BB (milestones): Bài ĐB ➡️ PV GVBB ➡️ ĐK Center ➡️ PV Học viên. Hoàn thành 100% cả 4 mốc mới mở nút Chốt Center (chuyển phase sang center).',
'',
'3. KẾT NỐI GHI CHÚ, LỊCH & TỰ ĐỘNG SINH TASK:',
'   - Khi chọn Ngày & Giờ (event_date) trong Ghi chú: Hệ thống tự động tạo bản ghi đính kèm sang records và calendar ➡️ hiển thị đồng thời trên Lịch biểu và Timeline.',
'   - Tự động tạo Task nhắc làm báo cáo: Đúng 1 giờ sau mốc hen_tv hoặc bc_bb, hàm checkAutoPriorityTasks() tự động chèn Task mới vào tab Ưu tiên.',
'',
'4. MÀN HÌNH HỒ SƠ 9 SUB-TABS & CÀI ĐẶT CÁ NHÂN:',
'   - Tab 1 Thông tin | Tab 2 Giai đoạn (Timeline) | Tab 3 Tư vấn | Tab 4 Bài học BB | Tab 5 BTVN | Tab 6 Ghi chú | Tab 7 Thảo luận | Tab 8 Thẻ HV (xuất Word .docx, Họ tên NDD lấy tự động từ Cài đặt cá nhân NDD) | Tab 9 Tư duy (Chiến lược 5 mục cl_* & Mindmap AI Markmap, nút "← Quay lại Hồ sơ").',
'   - Công thức Lịch Shin: Năm Shin = Năm Dương Lịch - 1983 (Năm 2026 là Shin 43.MM.DD). Định dạng Dương lịch DD.MM.YYYY.',
'   - Ghim Tab Desktop: Cài đặt ➡️ Ghim Tab (lưu cj_pinned_tabs trong localStorage để chia 2-3 cột).',
'   - Chức năng View As (_viewAsStaffCode): Cho phép Quản lý xem ứng dụng dưới tư cách TĐ khác.',
'',
...
'   - Quy tắc Drop-out: Khi chuyển trạng thái sang 🔴 Drop-out, ứng dụng BẮT BỘC hiển thị popup chọn Lý do nghỉ học (dropout_reason). Không chọn lý do không cho phép lưu.',
